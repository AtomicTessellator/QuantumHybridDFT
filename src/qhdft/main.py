...
def main() -> None:
    ...
    fineGrid, coarsePoints, coarseDensity, shapeFunction = setup_discretization(params)
    ...
    # Stage 6: Validation
    E = compute_energy(hat_n, fineGrid, coarsePoints, shapeFunction, params, beta)
    ...
    n_star = coarseDensity.copy()  # Placeholder; actual would run classical SCF
